...
export default function initModels(sequelize) {
  ...
  tbl_student.belongsToMany(tbl_subject, { as: 'r_sucode_tbl_subjects', through: tbl_code, foreignKey: "r_stcode", otherKey: "r_sucode" });
  tbl_subject.belongsToMany(tbl_student, { as: 'r_stcode_tbl_students', through: tbl_code, foreignKey: "r_sucode", otherKey: "r_stcode" });
  tbl_code.belongsTo(tbl_student, { as: "r_stcode_tbl_student", foreignKey: "r_stcode"});
  tbl_student.hasMany(tbl_code, { as: "tbl_codes", foreignKey: "r_stcode"});
  tbl_code.belongsTo(tbl_subject, { as: "r_sucode_tbl_subject", foreignKey: "r_sucode"});
